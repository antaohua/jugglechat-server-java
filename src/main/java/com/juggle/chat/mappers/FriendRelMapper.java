...
public interface FriendRelMapper {
    ...
    List<FriendRel> queryFriendRelsWithPage(@Param("appkey")String appkey, @Param("userId")String userId,
            @Param("orderTag")String orderTag, @Param("offset")long offset, @Param("size")long size);
    ...
    List<User> searchFriendsByName(@Param("appkey")String appkey, @Param("userId")String userId,
